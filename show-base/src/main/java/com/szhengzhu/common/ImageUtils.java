...
public final class ImageUtils {
     ...
     */
    public static BufferedImage pressImage(String targetImg, String waterImg, int x, int y, float alpha) {
    ...
    public static BufferedImage pressImage(BufferedImage image, String waterImg, int x, int y, float alpha) {
        try {
    ...
    public static BufferedImage pressText(File file, String pressText, String fontName, int fontStyle, int fontSize,
    ...
    public static BufferedImage pressText(BufferedImage image, String pressText, String fontName, int fontStyle,
            int fontSize, Color color, int x, int y, float alpha) {
        try {
            int width = image.getWidth(null);
            int height = image.getHeight(null);
    ...
    public static BufferedImage resize(BufferedImage bi, int width, int height, boolean bb) {
        ...
        if (bb) {
            ...
            if (width == itemp.getWidth(null))
                graphics.drawImage(itemp, 0, (height - itemp.getHeight(null)) / 2, itemp.getWidth(null),
                        itemp.getHeight(null), Color.white, null);
            else
                graphics.drawImage(itemp, (width - itemp.getWidth(null)) / 2, 0, itemp.getWidth(null),
                        itemp.getHeight(null), Color.white, null);
            graphics.dispose();
            return image;
        } else {
