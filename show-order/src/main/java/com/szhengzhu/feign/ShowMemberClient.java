...
//            @RequestBody PageParam<Map<String, String>> integralPage);
    ...
    @GetMapping(value = "/match/type")
    Result<List<MatchInfo>> selectByGiveChance(@RequestParam(value = "type", required = false) Integer type);
    ...
    @PostMapping(value = "/pay/back/combo/add")
    Result comboPayBack(@RequestBody PayBack payBack);
    ...
    Result<ComboBuy> queryByComboId(@PathVariable("markId") @NotBlank String markId);

    @GetMapping(value = "/combo/list")
    Result<List<ComboBuy>> queryComboList();

    @PostMapping(value = "/combo/add")
    Result addCombo(@RequestBody ComboBuy comboBuy);

    @PatchMapping(value = "/combo/modify")
    Result modifyCombo(@RequestBody ComboBuy comboBuy);

    @DeleteMapping(value = "/combo/{markId}")
    Result deleteByComboId(@PathVariable("markId") @NotBlank String markId);

    @GetMapping(value = "/combo/info")
    Result<List<ComboBuy>> queryComboInfo();

    @GetMapping(value = "/combo/receive/{markId}")
    Result<ComboReceive> queryByMemberComboId(@PathVariable("markId") String markId);

    @PostMapping("/combo/receive/list")
    Result<List<ComboReceive>> queryMemberComboList(@RequestBody ComboReceive comboReceive);

    @PostMapping(value = "/combo/receive/add")
    Result addMemberCombo(@RequestBody ComboReceive comboReceive);

    @GetMapping(value = "/combo/quantity")
    Result<Integer> queryComboQuantity(@RequestParam("userId") String userId, @RequestParam("comboId") String comboId);

    @GetMapping(value = "/combo/member")
    Result<List<ComboReceive>> queryMemberCombo(@RequestParam("userId") String userId,
                                                @RequestParam(value = "status", required = false) Integer status);

    @GetMapping(value = "/combo/pay/add")
    Result<ComboPay> memberBuyCombo(@RequestParam("comboId") String comboId, @RequestParam("quantity") Integer quantity,
                                    @RequestParam("userId") String userId, @RequestParam("openId") String openId);

    @GetMapping(value = "/combo/code")
    Result<ComboReceive> queryComboCode(@RequestParam("code") String code);

    @GetMapping(value = "/combo/use")
    Result useCombo(@RequestParam("code") String code);
}
